...
public class Main {
            ...
            if (!isFound) {
                ...
                if (tmpRes.first) {
                    ...
                    if (tmpRes.second != null) {
                        errors.put(2, "Expression " + lineNum + ": variable " + tmpRes.second +
                                " is not free for term " + tmpRes.third + " in ?@-axiom.");
                    }
                }
            }
    ...
    public static class Accumulator {
        ...
        private final HashMap<Expression, HashMap<Expression, Integer>> supposed;
    ...
    public interface Expression extends ExpressionOrOperation {
        ...
        Triple<Boolean, HashMap<Expression, Expression>, Boolean> tryCompareAndCheck(
                Expression expr, Boolean lowMatch, Boolean absoluteMatch,
                String variable, HashMap<String, Integer> boundVariables);
    ...
    enum Operation implements ExpressionOrOperation, BracketOrOperation {
        ...
        private final boolean rightAssociativeOrUnaryPostfix;
    ...
    public static Triple<Boolean, String, String> isAxiom11or12(Expression quantifiedExpr,
                                                                Expression expression, String operation) {
        ...
        if (quantifiedExpr instanceof QuantifiedExpression &&
            ...
            Triple<Boolean, HashMap<Expression, Expression>, Boolean> res = argument.tryCompareAndCheck(
                    expression, false, false, variable, new HashMap<>());
            if (!res.first) {
            ...
            if (andExpr instanceof LogicalAND) {
                ...
                if (quantifiedExpr instanceof QuantifiedExpression &&
                    ...
                    if (argument instanceof LogicalIMPLICATION) {
                        ...
                        Triple<Boolean, HashMap<Expression, Expression>, Boolean> res1 = phiExpr.tryCompareAndCheck(
                                tooPhiExpr, false, true, null, new HashMap<>());
                        if (!res1.first) {
                            return false;
                        }

                        Triple<Boolean, HashMap<Expression, Expression>, Boolean> res2 = phiExpr.tryCompareAndCheck(
                                leftPhiExpr, false, false, variable, new HashMap<>());

                        for (Map.Entry<Expression, Expression> pair : res2.second.entrySet()) {
                            if (pair.getKey() instanceof Variable &&
                                    ((Variable) pair.getKey()).getName().equals(variable)) {
                                if (!(pair.getValue() instanceof Variable &&
                                        "0".equals(((Variable) pair.getValue()).getName()))) {
                                    res2.first = false;
                                    break;
                                }
                            } else {
                        ...
                        Triple<Boolean, HashMap<Expression, Expression>, Boolean> res3 = phiExpr.tryCompareAndCheck(
                                rightPhiExpr, false, false, variable, new HashMap<>());
                            ...
                            if (pair.getKey() instanceof Variable &&
                                ...
                                if (pair.getValue() instanceof Increment) {
                                    ...
                                    if (!(var instanceof Variable &&
                                            ((Variable) var).getName().equals(variable))) {
                                        res3.first = false;
                                        break;
                                    }
                                } else {
