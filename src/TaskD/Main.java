...
public class Main {
    ...
    public static class Parser {
        private final HashMap<String, Expression> mapVariable;
        private final HashMap<String, Expression> mapScheme;
    ...
    enum Operations implements ExpressionOrOperation, BracketOrOperation {
        ...
        private final HashMap<String, Expression> mapOperation;
